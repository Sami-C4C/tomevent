...
class BackstageTicketVOTest {
    ...
    public void setup() throws CustomerNoDateOfBirthException, CustomerTooYoungException {
        ...
        ticket1 = new BackstageTicketVO(224, 45.60f, "B23", show, customer1);
    ...
    void test_equals_withObjectOfDifferentClass_returnsFalse() {
        ...
        TicketVO differentClassObject = new TicketVO(ticket3.getNumber(), ticket3.getId(), ticket3.getBasePrice(), show) {
    ...
    void test_compareTo_withHigherId_returnsPositive() {
        ...
        assertTrue(higherIdTicket.compareTo(ticket2) > 0);
    }
    ...
    void test_hashCode_sameAttributes_returnsSameHashCode() {
        BackstageTicketVO anotherTicket = new BackstageTicketVO(ticket1.getNumber(), ticket1.getBasePrice(), ticket1.getSeat(), show, customer1);
